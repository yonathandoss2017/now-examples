        ...
        for filename in files:
            ...
            try:
                with open(path, "r", errors='ignore') as f:
                    content = f.read()
                for sha_match in re.finditer(r"\b([a-f0-9]{40})\b", content):
...
def main():
    ...
    net_group.add_argument("-j", "--jobs", type=int, default=10, help="Número de peticiones simultáneas (default: 10)")
